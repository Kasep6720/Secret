...
do
	...
	function library.new(title)
		...
		--Mobile Toggle UI
		local DHV2Frame = Instance.new("ImageLabel")
		local TextLabelFrame = Instance.new("ImageLabel")
		DHV2TextButton = Instance.new("ImageButton")
		DHV2TextButtonText = Instance.new("TextButton")

		DHV2Frame.Parent = container
		DHV2Frame.Name = title .." Toggle"
		DHV2Frame.BackgroundTransparency = 1
		DHV2Frame.Position = game:GetService("CoreGui").TopBarApp.TopBarApp.MenuIconHolder.TriggerPoint.Position+UDim2.new(0.0105, 0, 0.005, 0)
		DHV2Frame.Size = UDim2.new(0, 40, 0, 40)
		DHV2Frame.Image = "rbxassetid://4641149554"
		DHV2Frame.ImageColor3 = Color3.fromRGB(24, 24, 24)
		DHV2Frame.ScaleType = Enum.ScaleType.Slice
		DHV2Frame.SliceCenter = Rect.new(4, 4, 296, 296)
		DHV2Frame.Active = true
		DHV2Frame.Visible = false

		TextLabelFrame.Parent = DHV2Frame
		TextLabelFrame.Name = "TopBar"
		TextLabelFrame.BackgroundTransparency = 1
		TextLabelFrame.ClipsDescendants = true
		TextLabelFrame.Size = UDim2.new(0, 40, 0, 8)
		...
		DHV2TextButton.Parent = DHV2Frame
		DHV2TextButton.Name = "Button"
		DHV2TextButton.BackgroundTransparency = 1
		DHV2TextButton.Position = UDim2.new(0, 0, 0, 0)
		DHV2TextButton.BorderSizePixel = 0
		DHV2TextButton.Size = UDim2.new(0, 40, 0, 40)
		DHV2TextButton.ZIndex = 2
		DHV2TextButton.ScaleType = Enum.ScaleType.Slice
		DHV2TextButton.SliceCenter = Rect.new(2, 2, 298, 298)

		DHV2TextButtonText.Parent = DHV2TextButton
		DHV2TextButtonText.BackgroundColor3 = Color3.fromRGB(27, 27, 27)
		DHV2TextButtonText.BackgroundTransparency = 1
		DHV2TextButtonText.ZIndex = 3
		DHV2TextButtonText.Size = UDim2.new(0, 40, 0, 40)
		DHV2TextButtonText.Font = Enum.Font.TitilliumWeb
		DHV2TextButtonText.Text = "+"
		DHV2TextButtonText.TextColor3 = Color3.fromRGB(200, 200, 200)
		DHV2TextButtonText.TextScaled = true
		DHV2TextButtonText.TextSize = 10.000
		DHV2TextButtonText.TextWrapped = true
